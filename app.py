...
app = FastAPI(title="RAG Chatbot API", description="API for a RAG-based chatbot using Gemini LLM", version="1.0")

# Root endpoint for testing
@app.get("/")
def root():
    return {"message": "RAG Chatbot API is running. Use /chat, /upload-doc, /list-docs, /delete-doc endpoints."}
