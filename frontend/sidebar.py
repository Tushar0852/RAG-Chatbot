...
from app.frontend.api_utils import upload_document, list_documents, delete_document

def display_sidebar():
    # Model selection - Only Gemini 2.5 Flash
    st.sidebar.selectbox("Select Model", options=["gemini-2.5-flash"], key="model")
